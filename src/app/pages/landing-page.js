...
const LandingPage = () => {
    ...
    const templateHostname = window.location.hostname; // Use hostname instead of host
    const templateURL = encodeURIComponent(`http://${templateHostname}${window.location.pathname}`);
